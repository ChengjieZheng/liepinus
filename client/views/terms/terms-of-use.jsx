...
//  import materials-ui components
import Grid from 'material-ui/Grid'

//  import css style
import { withStyles } from 'material-ui'
import termsOfUseStyle from './terms-of-use-style'
...
class TermsOfUse extends React.Component {
	...
	render() {
		...
		console.log('classes from props: ', classes)
		return (
				...
				<Header />
					<div className={classes.siteContent}>
						<Grid container spacing={24}>
							...
							<Grid item xs={10} >
								<article>
									<h1>TERMS OF USE LIEPIN NORTH AMERICA, INC.</h1>
									<p>Version Date: December 28, 2017</p>
									<p>
										TERMS OF USE AGREEMENT

												This Terms of Use Agreement (“Agreement”) constitutes a legally binding agreement made between you, whether personally or on behalf of an entity (“user” or “you”) and LIEPIN NORTH AMERICA, INC. and its affiliated companies (collectively, “Company” or “we” or “us” or “our”), concerning your access to and use of the https://www.liepinus.com website as well as any other media form, media channel, mobile website or mobile application related or connected thereto (collectively, the “Website”). The Website provides the following service: Digital goods. Customized Marketing Package; Online Training Course; RPO service, etc,. (“Company Services”). Supplemental terms and conditions or documents that may be posted on the Website from time to time, are hereby expressly incorporated into this Agreement by reference.
												...
												A.    Governing Law; Jurisdiction. This Agreement and all aspects of the Website and Company Services shall be governed by and construed in accordance with the internal laws of the State/Commonwealth of Massachusetts, without regard to conflict of law provisions. With respect to any disputes or claims not subject to informal dispute resolution or arbitration (as set forth below), you agree not to commence or prosecute any action in connection therewith other than in the state and federal courts located in Boston County, State of Massachusetts, and you hereby consent to, and waive all defenses of lack of personal jurisdiction and forum non conveniens with respect to, venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods is excluded from this Agreement. Additionally, application of the Uniform Computer Information Transaction Act (UCITA) is excluded from this Agreement. In no event shall any claim, action or proceeding by you related in any way to the Website or Company Services be instituted more than two (2) years after the cause of action arose.
												...
												IN NO EVENT SHALL COMPANY OR ITS DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DIRECT, INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL OR PUNITIVE DAMAGES, INCLUDING LOST PROFIT, LOST REVENUE, LOSS OF DATA OR OTHER DAMAGES ARISING FROM YOUR USE OF THE WEBSITE OR COMPANY SERVICES, EVEN IF COMPANY HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. NOTWITHSTANDING ANYTHING TO THE CONTRARY CONTAINED HEREIN, COMPANY’S LIABILITY TO YOU FOR ANY CAUSE WHATSOEVER AND REGARDLESS OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO THE AMOUNT PAID, IF ANY, BY YOU TO COMPANY FOR THE COMPANY SERVICES DURING THE PERIOD OF 3 PRIOR TO ANY CAUSE OF ACTION ARISING.
												...
												Users are allowed on LIEPIN NORTH AMERICA, INC. to transmit and receive valid electronic signatures in the United States under the Electronic Signatures in Global and National Commerce Act (E-Sign Act) of 2000 and the Uniform Electronic Transactions Act (UETA) of 1999 as adopted by individual states. Users’ signatures and identities are not authenticated on LIEPIN NORTH AMERICA, INC..
...
export default withStyles(termsOfUseStyle)(TermsOfUse)
